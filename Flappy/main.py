...
class Main:
    ...
    def tick(self):
        if global_var.get("menu") == "game":
            ...
            render_image(
                set_size(pygame.transform.rotate(self.player_textures["1alive"], self.player_obj.angle), 1.2),
            ...
            render_text("Use your mouse to move the pipes", 50, 0, 150 + math.sin(self.time * 2.5 + 2) * 10, (146, 195, 184))
